...
const TYPE_ICON: Record<string, string> = {
  QUIZ_COMPLETED: 'ðŸ†', LESSON_ASSIGNED: 'ðŸ“š', PROGRESS_REPORT: 'ðŸ“Š'
};
  ...
  return (
    <SidebarLayout>
      <div className="max-w-2xl mx-auto">
        ...
        {loading && <p className="text-white text-center mt-20 animate-pulse">Loadingâ€¦</p>}

        {!loading && notifs.length === 0 && (
          <div className="card text-center py-16">
            <div className="text-5xl mb-4">ðŸ“­</div>
            <p className="text-gray-600 text-lg">No notifications yet</p>
            <p className="text-gray-400 text-sm mt-2">You'll see quiz results and lesson updates here</p>
          </div>
        )}
        ...
        <div className="space-y-3">
          {notifs.map(n => (
            <div key={n.id} onClick={() => markRead(n.id)}
              ...
              <span className="text-2xl flex-shrink-0 mt-0.5">{TYPE_ICON[n.type] ?? 'ðŸ””'}</span>
